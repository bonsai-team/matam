...
To install all of the needed depencies except samtools and Java, you can run the following command-line in Debian-like distributions :

  `sudo apt-get update && sudo apt-get install curl git gcc g++ python3 automake make cmake ant libsparsehash-dev zlib1g-dev bzip2`
